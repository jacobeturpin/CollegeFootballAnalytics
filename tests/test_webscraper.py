...
class GameScraperTest(unittest.TestCase):
    ...
    def test_get_game_summary_info(self):
        ...
        self.assertEquals(expected_item, self.sm.get_game_summary_info(content, link))
    ...
    def test_get_game_team_stats(self):
        ...
        expected_item = [(('California', '/cfb/schools/california/2003.html'), '365', '66', '5.5', '19', '13',
                         ...
                         '7', '52')]
        self.assertEquals(expected_item, self.sm.get_game_team_stats(content))
    ...
    def test_get_passing_stats(self):
        ...
        self.assertIn(expected_item, self.sm.get_passing_stats(content))
    ...
    def test_get_rush_receive_stats(self):
        ...
        self.assertIn(expected_item, self.sm.get_rush_receive_stats(content))
    ...
    def test_get_defense_stats(self):
        ...
        self.assertIn(expected_item, self.sm.get_defense_stats(content))
    ...
    def test_get_return_stats(self):
        ...
        expected_item = (('Antonio Brown', '/cfb/players/antonio-brown-1.html'),
                         ...
                         '4', '68', '17.0', '0', 0, 0, 0, 0)
        self.assertIn(expected_item, self.sm.get_return_stats(content))
    ...
    def test_get_kick_punt_stats(self):
        ...
        self.assertIn(expected_item, self.sm.get_kick_punt_stats(content))
